...
char menu()
{
	...
	printf("A - Alta Electro\n");
	printf("B - Modificar Electro\n");
	printf("C - Borrar datos Electro\n");
	printf("D - Informar lista de Electros\n");
	printf("E - Listar las Marcas\n");
	printf("F - Listar Servicios\n");
	printf("G - Dar de alta una Reparacion\n");
	printf("H - Listar Reparaciones\n");
	printf("I - Salir \n");
	fflush(stdin);
	utn_getChar(&opcion, "Elija una opcion: \n", "ERROR. OPCION INVALIDA\n", 'A', 'I', 7);
	return opcion;
}
